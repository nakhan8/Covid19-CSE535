...
public class HeartRateView extends AppCompatActivity {
    ...
    TextureView.SurfaceTextureListener textureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            ...
            if (numCaptures == 20) {
                ...
                if (prevRollAvg > currRollAvg && prevRollAvg > finalLastRollAvg && numBeats < timing) {
    ...
    private void openCamera() {
        ...
        try {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(HeartRateView.this, new String[]{Manifest.permission.CAMERA}, REQUEST_CAMERA_PERMISSION);
                return;
            }
    ...
    private void calculateBeatsPerMinute() {
        int med;
        long [] timedist = new long [timing - 1];
    ...
    private void addTodb()
    {
        ...
        returnIntent.putExtra("HEART_RATE_VALUE", heartRateBPM +"");
